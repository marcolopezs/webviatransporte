                        ...
                        <section id="archive-page" class="module-timeline">
                            ...
                            <div class="articles">
                                ...
                                <?php while($fila_noticias=mysql_fetch_array($rst_noticias)){
                                    ...
                                    $noticia_fechaEvento=$fila_noticias["fecha_evento"];
                                    ...
                                    //SEPARACION DE FECHA
                                    $fechaSep=explode("-", $noticia_fechaEvento);
                                    $FechaDia=$fechaSep[2];
                                    $FechaMes=mesCorto($fechaSep[1]);
                                    $FechaAnio=$fechaSep[0];

                                    //URLS
                                    $noticia_UrlWeb=$web."evento/".$noticia_id."-".$noticia_url;
                                    $noticia_UrlImg=$web."imagenes/upload/".$noticia_imagen_carpeta."thumb/".$noticia_imagen;
                                ?>
                                
                                <article>
                                    <span class="published"><?php echo $FechaDia." ".$FechaMes." ".$FechaAnio; ?></span>
