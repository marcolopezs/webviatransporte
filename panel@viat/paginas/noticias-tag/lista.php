...
// Data Gathering
$params['sql_query']                = "SELECT id,nombre FROM ".$tabla_suf."_noticia_tags ORDER BY nombre ASC";
...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-screen"></span>Noticias - Etiquetas</span>
    </div>
    ...
    <div class="wrapper">
        ...
        <!-- Media table sample -->
        <div class="widget">
            <div class="whead"><h6>Noticias - Etiquetas</h6></div>
