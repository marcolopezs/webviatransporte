...
//EDITAR
$rst_nota=mysql_query("SELECT * FROM ".$tabla_suf."_galeria_slide WHERE id=$id_url;", $conexion);
...
<div id="content">
    ...
    <div class="wrapper">
        ...
        <form id="submit-form" class="main" method="POST" action="s-editar.php?id=<?php echo $id_url; ?>&not=<?php echo $reqId; ?>">
