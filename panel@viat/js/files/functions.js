$(function() {
	...
	//===== File uploader: SLIDER SUPERIOR =====//
	
	$("#uploader_slide").pluploadQueue({
		runtimes : 'html5,html4',
		url : '/panel@viat/php/upload_slide.php',
		max_file_size : '100mb',
		chunk_size : '1mb',
		unique_names : true,
		dragdrop: false,
		resize: {width: 1950, height: 950, quality: 90},
		filters : [
	...
	$("#uploader_galeria").pluploadQueue({
		runtimes : 'html5,html4',
		url : '/panel@viat/php/upload_galeria.php',
		max_file_size : '100mb',
		chunk_size : '1mb',
		unique_names : true,
		dragdrop: false,
	...
	$("#uploader_pdf").pluploadQueue({
		runtimes : 'html5,html4',
		url : '/panel@viat/php/upload_pdf.php',
		max_file_size : '200mb',
		chunk_size : '1mb',
		unique_names : true,
		dragdrop: false,
	...
	$("#uploader_video").pluploadQueue({
		runtimes : 'html5,html4',
		url : '/panel@viat/php/upload_video.php',
		max_file_size : '500mb',
		chunk_size : '1mb',
		unique_names : true,
		dragdrop: false,
	...
	$("#uploader_columnista").pluploadQueue({
		runtimes : 'html5,html4',
		url : '/panel@viat/php/upload_columnista.php',
		max_file_size : '100mb',
		chunk_size : '1mb',
		unique_names : true,
		dragdrop: false,
